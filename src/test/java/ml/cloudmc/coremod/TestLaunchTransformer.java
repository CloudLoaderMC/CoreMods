...
public class TestLaunchTransformer {
    ...
    public void testCoreModLoading() {
        ...
        System.setProperty("test.harness.callable", "ml.cloudmc.coremod.TestLaunchTransformer$Callback");
    ...
    public static class Callback {
        ...
        public static Callable<Void> supplier() {
            ...
            try {
                final Class<?> clazz = Class.forName("ml.cloudmc.coremod.ArmsLengthHandler", true, contextClassLoader);
